...
export function HabitEditModal({ habit, onSave, onClose, isSaving }: HabitEditModalProps) {
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-surface to-bg border border-white/[0.06] rounded-2xl w-[440px] max-h-[85vh] overflow-y-auto shadow-[0_24px_48px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.04),0_0_80px_rgba(63,145,66,0.06)] animate-[modalSlideIn_0.25s_ease-out]"
