    ...
    <div className="px-5 py-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="w-8 h-8 rounded-xl bg-accent/15 hover:bg-accent/25 text-accent hover:text-accent-hover flex items-center justify-center transition-all hover:shadow-[0_0_12px_rgba(63,145,66,0.3)] hover:scale-105 active:scale-95"
        >
            ...
            <button
              ...
              className={`w-6 h-6 rounded-lg flex items-center justify-center transition-all duration-200 shrink-0 ${
                habit.completedToday
                  ? 'bg-accent text-white shadow-[0_0_10px_rgba(63,145,66,0.4)] scale-105'
