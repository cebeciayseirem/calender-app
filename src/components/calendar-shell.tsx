      ...
      {view !== 'daily' && (
        <footer className="fixed bottom-0 left-0 w-full h-16 bg-bg flex items-center justify-end px-6 z-[100]">
          <button
            ...
            className="group w-11 h-11 rounded-xl bg-gradient-to-br from-accent to-accent-hover text-white border-none cursor-pointer shadow-[0_4px_16px_rgba(63,145,66,0.35)] flex items-center justify-center transition-all duration-200 hover:scale-105 hover:shadow-[0_6px_24px_rgba(63,145,66,0.5)] active:scale-95"
          >
