...
const SEED_DATA: SeedEvent[] = [
  ...
  },
  {
    ...
    description: 'Vinyasa flow class focusing on hip openers and shoulder stretches. Bring your own mat.',
  ...
  },
  {
    ...
    start: '2026-03-09T17:30:00',
    end: '2026-03-09T18:30:00',
  ...
  },
  {
    ...
    description: 'Routine cleaning and checkup. Mention sensitivity on lower left molar.',
    location: 'Bright Smiles Dental, 320 Oak Blvd, Suite 200',
    color: CATEGORY_COLORS.Health,
    category: 'Health',
  },
  {
  ...
  },
  {
    ...
    description: 'Discussing "Project Hail Mary" by Andy Weir. Bring snacks for your turn.',
  ...
  // ── Wednesday Mar 11 ──
  {
    ...
    description: 'Review pull requests for the authentication refactor and provide feedback on test coverage.',
  ...
  {
    title: 'Gym — Leg Day',
    start: '2026-03-11T07:00:00',
    end: '2026-03-11T08:15:00',
  ...
  },
  {
    ...
    start: '2026-03-11T17:00:00',
    end: '2026-03-11T17:30:00',
    description: 'Pick up the suit and two dress shirts dropped off last week. Ticket #4782.',
  ...
  // ── Thursday Mar 12 ──
  {
    ...
    description: 'Sprint 13 retro — discuss what went well, what didn\'t, and action items for improvement.',
  ...
  },
  {
    ...
    description: 'Meet with financial advisor to review savings plan and discuss refinancing options.',
  ...
  },
  {
    ...
    description: 'Board game night — playing Catan, Ticket to Ride, and Codenames. Bring beverages.',
  ...
  {
    title: 'Evening Run',
    start: '2026-03-13T18:00:00',
    end: '2026-03-13T19:00:00',
    description: '5K run along the river trail. Focus on maintaining a 9-minute mile pace.',
