...
const SEED_DATA: SeedEvent[] = [
  ...
  {
    title: 'Morning Yoga',
    start: '2026-03-23T06:30:00',
    end: '2026-03-23T07:30:00',
  ...
  },
  {
    ...
    description: 'Plan sprint 16 tasks, assign story points, and review backlog priorities with the dev team.',
  ...
  },
  {
    ...
    start: '2026-03-24T19:00:00',
    end: '2026-03-24T20:30:00',
  ...
  {
    title: 'Morning Run',
    start: '2026-03-25T06:30:00',
    end: '2026-03-25T07:30:00',
  ...
  },
  {
    ...
    start: '2026-03-25T20:00:00',
    end: '2026-03-25T21:30:00',
  ...
  },
  {
    ...
    description: 'Sprint 15 retro — what went well, what didn\'t, and action items for improvement.',
  ...
  {
    title: 'Gym — Leg Day',
    start: '2026-03-27T07:00:00',
    end: '2026-03-27T08:15:00',
  ...
  {
    title: 'Happy Hour',
    start: '2026-03-27T17:00:00',
    end: '2026-03-27T19:00:00',
  ...
  {
    title: 'Meal Prep',
    start: '2026-03-29T12:30:00',
    end: '2026-03-29T14:00:00',
...
export function deleteAllEvents(sqlite: Database.Database): void {
  sqlite.prepare('DELETE FROM events').run();
}

export function seedEvents(sqlite: Database.Database): void {
  const existing = sqlite.prepare("SELECT COUNT(*) as count FROM events WHERE title = 'Sprint Planning' AND start LIKE '2026-03-23%'").get() as { count: number };
  if (existing.count > 0) return;
